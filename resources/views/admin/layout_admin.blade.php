	...
	<body>
		<div class="d-flex">
			<div class="col-md-2 min-vh-100 bg-dark text-light">
				...
				<div class="mx-5">
					<ul class="navbar-nav">
						<li class="nav-item"><a href="/admin/pesanan" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-columns-gap me-3" viewBox="0 0 16 16">
